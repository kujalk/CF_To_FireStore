...
# initializations 
cred = credentials.Certificate(r"E:\\key.json")
...
def write_batch_data(data):
    try:
        ...
        collection_name = f"country_{str(datetime.datetime.now().date())}_{random_string}"
        ...
        logger.info("Done with inserting data")
